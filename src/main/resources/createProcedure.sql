...
BEGIN
    ...
    IF categoria_id IS NULL THEN
        INSERT INTO Categoria (nome, descricao) VALUES (nome_categoria, descricao_categoria);
    ...
    VALUES (nome, descricao, preco_compra, preco_venda, quantidade_estoque, categoria_id);
